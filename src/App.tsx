...
function App() {
  ...
  return (
    <div className="container">
        <h1>Coffee Shoe Finder</h1>
        <select name="" onChange={handleChange} value={sortOption}>
          <option value="distance">Distance</option>
          <option value="name">Price</option>
        </select>
        <div className="main">
          {placeData?.sort((a: any, b: any) => (sortOption === 'distance' ? (a.venue.location.distance > b.venue.location.distance) : (a.venue.name > b.venue.name)) ? 1 : -1)
